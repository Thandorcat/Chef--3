...
execute 'Adding mysql-community-repo' do
...
bash 'create database' do  
	code <<-EOH
	mysql -S /var/run/mysql-default/mysqld.sock -uroot -ppassword -e "create 
	database task3 character set utf8 collate utf8_bin;" 
	EOH
	action :run
